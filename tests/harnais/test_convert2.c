...
static void ma_ligne(HcLineKind kind, int depth, const char *text) {
    (void)depth;
...
int main(void)
{
    ...
    run(btn, "print carte courante", "print card");
    run(btn, "print toute la pile", "print all cards");
    run(btn, "print une plage", "print card 1 to 3");
