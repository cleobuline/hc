...
int main(void){
  ...
  essai("put there is a field \"menu\"");
  essai("put there is a field \"absent\"");
  essai("put there is no field \"absent\"");
  essai("if there is a field \"absent\" then put \"oui\"\n  else put \"non\"");
  essai("put field \"absent\"");
  essai("put the short name of field \"absent\"");
