...
int main(void)
{
    ...
    printf("\n");
    printf("   CE QUE CETTE SECTION MONTRE ET QUI RESTE À FAIRE : la boucle va\n");
    printf("   AU BOUT, et errorDialog ne reçoit l'erreur qu'à la sortie du\n");
    printf("   gestionnaire le plus extérieur. Chez HyperCard une erreur ARRÊTE\n");
    printf("   le gestionnaire, et errorDialog part aussitôt.\n");
    printf("\n");
    printf("   La différence ne vient pas du verrou mais de la façon dont les\n");
    printf("   COMMANDES signalent : « put the zorglub » lève une faute et\n");
    printf("   interrompt — section 3 le montre —, tandis que « drag » se\n");
    printf("   contente d'un emit(HC_ERR) et rend « traité ». Deux façons de\n");
